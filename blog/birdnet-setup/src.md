...
<summary class="alert-heading">Before you step through these instructions, first read [Intro to BirdNET-Pi: Eavesdropping on my feathered friends (and how you can, too!)](../birdnet-intro/) 🐦‍⬛</summary>
</div>
...
<br>
<div class="alert" style="background:#e8ebf5; padding: .5em;">
<summary class="alert-heading">Next step, now that you've got your basic set-up running: [Text of the wild: Receiving notifications from your BirdNET-Pi](../birdnet-text-notifications) 🐦‍⬛</summary>
</div>
